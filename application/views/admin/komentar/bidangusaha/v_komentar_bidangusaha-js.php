<script>
    ...
    $(function () {
        pagination("datatabel", base_url+"/admin/komentar/getdata?cType=bidangusaha", []);
    ...
    $('#f_komentar').submit(function(e){
        ...
        fd.append('cMessageReply',cMessageReply);
                $.ajax({
            url:'<?php echo base_url();?>/admin/komentar/sendReplyb',
            type:"post",
            data:fd,
            processData:false,
            contentType:false,
    ...
    $('#f_submit_hapus').submit(function(e){
        ...
        e.preventDefault(); 
        $.ajax({
            url:'<?php echo base_url();?>/admin/komentar/deleteb',
            type:"post",
    ...
    function komentar_open(id) {
        $.ajax({
        type: "GET",
        url: base_url+"admin/komentar/detailb/"+id,
        success: function(data) {
            console.log(data);
            if(data.Status < 2){
    ...
    $('#f_submit_publish').submit(function(e){
        ...
        e.preventDefault(); 
        $.ajax({
            url:'<?php echo base_url();?>/admin/komentar/publishb',
            type:"post",
            data:new FormData(this),
            processData:false,
            contentType:false,
