...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 29 Sep 2020 pada 14.39
...
(1, 'Kedatangan Tamu Asing', '2016-09-08 13:00:55', 1, 'Adlu Bagus I.', 5, '202aa754590dfc1070c624bad294abbc.jpg'),
(3, 'Pemilu Osis 2016-2017', '2017-01-21 01:58:16', 1, 'Adlu Bagus I.', 3, 'dc088a9fb62333012ff7a601828219d7.jpg'),
(4, 'Kegiatan Belajar Siswa', '2017-01-24 01:31:13', 1, 'Adlu Bagus I.', 7, '203bc0411a07ed0430d39bcc38ec2c56.jpg');
...
(2, 'msAboutUs_Deskripsi', '<p>Ei mel semper vocent persequeris, nominavi patrioque vituperata id vim, cu eam gloriatur philosophia deterruisset. Meliore perfecto repudiare ea nam, ne mea duis temporibus. Id quo accusam consequuntur, eum ea debitis urbanitas. Nibh reformidans vim ne. Iudico definiebas eos ea, dicat inermis hendrerit vel ei, legimus copiosae quo at. Per utinam corrumpit prodesset te, liber praesent eos an. An prodesset neglegentur qui, usu ancillae posidonium in, mea ex eros animal scribentur. Et simul fabellas sit. Populo inimicus ne est</p>\n\n<p>haha</p>\n');
...
(8, '-', 'Ririn Febriesta', 'P', 'Malang', '27 September 1994', 'Pend. Agama Islam', NULL, '2017-01-27 04:28:23');
...
(4, 'Komentar test', 'test@komen.com', '----<br />\r\n ', '2019-05-19 05:52:39', '1', 23, 0),
(5, 'Adlu Bagus I.', '', 'hai', '2019-06-09 04:08:34', '1', 23, 4);
...
(6, 'Administrator', NULL, 'L', 'kamisama', '97485d10a8b381d8477aa1496240ab0a', NULL, 'info@banatechindo.com', '081246319759', NULL, NULL, NULL, NULL, 1, '1', '2020-09-28 15:37:00', 'cee3e96c815817f3b9ecb9980c5e63d5.jpg');
...
(1, 'Pengumuman Libur Semester Ganjil Tahun Ajaran 2016-2017', 'Libur semester ganjil tahun ajaran 2016-2017 dimulai dari tanggal 3 Maret 2017 sampai dengan tanggal 7 Maret 207.', '2017-01-21 01:17:30', 'Adlu Bagus I.'),
(2, 'Pengumuman Pembagian Raport Semester Ganjil Tahun Ajaran 2018-2091', 'Menjelang berakhirnya proses belajar-mengajar di semester ganjil tahun ajaran 2018-2017, maka akan diadakan pembagian hasil belajar/raport pada tanggal 4 Mei 2019 pukul 07.30 WIB.\r\nYang bertempat di M-Sekolah. Raport diambil oleh orang tua/wali kelas murid masing-masing', '2017-01-21 01:16:20', 'Adlu Bagus I.'),
(3, 'Pengumuman Peresmian dan Launching Website Perdana TK Taman Siswa Turen', 'Peresmian dan launching website resmi M-Sekolah akan diadakan pada hari 23 Desember 2016 pukul 10.00, bertepatan dengan pembagian raport semester ganjil tahun ajaran 2016-2017', '2017-01-22 07:16:16', 'Adlu Bagus I.'),
(4, 'Pengumuman Proses Belajar Mengajar di Semester Genap Tahun Ajaran 2016-2017', 'Setelah libur semester ganjil tahun ajaran 2019-2020, proses belajar mengajar di semester genap tahun ajaran 2019-2020 mulai aktif kembali tanggal 2 Juli 2019.', '2017-01-22 07:15:28', 'Adlu Bagus I.');
...
(931, '2019-05-08 05:18:46', '::1', 'Chrome'),
(932, '2019-05-13 06:30:44', '::1', 'Chrome'),
(933, '2019-05-15 03:08:27', '::1', 'Chrome'),
(934, '2019-05-18 06:01:30', '::1', 'Chrome'),
(935, '2019-05-19 05:13:59', '::1', 'Chrome'),
(936, '2019-05-20 03:08:44', '::1', 'Chrome'),
(937, '2019-05-21 05:41:08', '::1', 'Chrome'),
(938, '2019-05-23 15:30:58', '::1', 'Chrome'),
(939, '2019-06-09 02:58:51', '::1', 'Firefox'),
(940, '2019-06-23 14:22:37', '::1', 'Chrome'),
(941, '2020-03-12 12:26:04', '::1', 'Chrome'),
(942, '2020-05-16 05:31:47', '::1', 'Chrome'),
(943, '2020-05-24 09:14:43', '::1', 'Chrome'),
(944, '2020-06-03 09:46:00', '::1', 'Chrome'),
(945, '2020-09-25 03:05:52', '::1', 'Chrome'),
(946, '2020-09-25 16:01:11', '::1', 'Firefox'),
(947, '2020-09-27 02:21:53', '::1', 'Chrome'),
(948, '2020-09-29 11:59:20', '::1', 'Chrome');
...
INSERT INTO `tbl_portfolio` (`ID`, `Judul`, `Deskripsi`, `Kategori`, `Foto`, `DateTime`) VALUES
(3, 'Banatech', '<p>Test deskripsi</p>\n', 'WD001', '60cfca41f0c12a3cc75870bf82fb2c54.png', '2020-09-28 17:45:13'),
(5, 'Test', '<p>HAHAAHA</p>\n', 'GD001', '3515ea1d65b57e91472a9510e3bcb967.png', '2020-09-28 17:58:48');
...
--
-- Dumping data untuk tabel `tbl_portfolio_kategori`
--

INSERT INTO `tbl_portfolio_kategori` (`ID`, `Kode`, `Keterangan`) VALUES
(1, 'WD001', 'Web Design'),
(2, 'GD001', 'Graphic Design');
...
--
-- Indeks untuk tabel `tbl_portfolio_kategori`
--
ALTER TABLE `tbl_portfolio_kategori`
  ADD PRIMARY KEY (`ID`);
...
--
-- AUTO_INCREMENT untuk tabel `tbl_portfolio_kategori`
--
ALTER TABLE `tbl_portfolio_kategori`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
